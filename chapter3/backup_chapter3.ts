...
console.log(getFullName(person40)); // Eric Hiệu
...
class Employee1 extends Person3 {
  ...
  //overwrite
  describe(): string {
    return `${super.describe()} from parent - describe Hiệu`;
  }
}
...
let employee = new Employee1("Hiệu", "Eric", "Web Developer");
...
let person2 = new Person2(25, "Hiệu", "Eric");
...
let hoidanit = new Person("123", "Hiệu", " Eric");
...
// console.log(">>> check add new: ", addNew(6, 9), addNew(" Hiệu", " & Eric"))
...
console.log(Greet("Xin chao", "Eric &", "Hiệu")); // returns "Hello Steve, Bill!"
